...
<body>
  ...
  <div class="intro">
    <h1>🌟 Witaj na Stworki Pooki! 🌟</h1>
    <p>Dołącz do naszej wyjątkowej społeczności – pełnej śmiechu, memów, dram, a przede wszystkim dobrego klimatu!</p>
    <a class="join-btn" href="https://discord.gg/bav5Wg56" target="_blank">💬 Dołącz do nas na Discordzie</a>
  </div>

  <h1>📘 Stworki Pooki – Regulamin i System Kar</h1>

  <!-- ... reszta Twojej strony (wszystko od <section> się nie zmienia) ... -->
  ...
  <!-- (cała zawartość Twojej strony pozostaje bez zmian od tego momentu) -->

  <div class="footer">
    © 2025 Stworki Pooki Discord | Projekt by ChatGPT
  </div>
</body>
</html>
